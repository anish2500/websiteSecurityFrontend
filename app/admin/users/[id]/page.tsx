        ...
        <div className="p-6 md:p-10 bg-slate-50/30 min-h-screen">
            <div className="max-w-3xl mx-auto">
                ...
                <div className="bg-white rounded-3xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-emerald-50/50">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10 pb-8 border-b border-slate-100">
                        <div className="flex items-center gap-5">
                            <div className="h-20 w-20 rounded-2xl bg-emerald-100 flex items-center justify-center text-emerald-600 text-3xl font-bold shadow-inner">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-12">
                        ...
                        <div className="space-y-1">
                            <p className="text-[10px] uppercase tracking-widest font-bold text-slate-400">Account Username</p>
                            <p className="text-slate-700 font-medium">{user.username}</p>
                        </div>

                        <div className="space-y-1">
                            <p className="text-[10px] uppercase tracking-widest font-bold text-slate-400">System Permissions</p>
                            <p className="text-slate-700 font-medium capitalize">{user.role}</p>
                        </div>

                        <div className="space-y-1">
                            <p className="text-[10px] uppercase tracking-widest font-bold text-slate-400">Account ID</p>
                ...
                <p className="text-center text-slate-400 text-xs mt-8">
                    User information is strictly for administrative use only.
                </p>
            </div>
        </div>
    );
